...
from projection_filter.exponential_family_projection_filter_nc_nstd \
    import PlainProjectionFilter
...
class MultiDimensionalPlainProjectionFilter(MultiDimensionalProjectionFilter,
                                            PlainProjectionFilter):
    ...
    def __init__(self,
        ...
        PlainProjectionFilter.__init__(self,
                                       dynamic_sde,
                                       measurement_sde,
