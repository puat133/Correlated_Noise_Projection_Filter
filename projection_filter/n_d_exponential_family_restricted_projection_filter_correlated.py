...
from projection_filter.exponential_family_projection_filter_correlated_restricted \
    import RestrictedCorrelatedProjectionFilter
from projection_filter.n_d_exponential_family_projection_filter import MultiDimensionalProjectionFilter
from symbolic.n_d import get_projection_filter_matrices_correlated
from symbolic.one_d import SDE


class MultiDimensionalRestrictedCorrelatedProjectionFilter(MultiDimensionalProjectionFilter,
                                                           RestrictedCorrelatedProjectionFilter):
    def __init__(self,
                 dynamic_sde: SDE,
                 measurement_sde: SDE,
        ...
        super(MultiDimensionalRestrictedCorrelatedProjectionFilter, self).__init__(dynamic_sde,
                                                                                   measurement_sde,
    ...
    def _get_projection_filter_matrices(self) -> tuple[list[onp.ndarray], list[tuple], list[tuple]]:
        return get_projection_filter_matrices_correlated(self.natural_statistics_symbolic,
                                                         self._dynamic_sde,
